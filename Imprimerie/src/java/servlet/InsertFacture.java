 ...
 * @author Ari
 */
public class InsertFacture extends HttpServlet {
        ...
        try {
            ...
            for(int i=0;i<nbr;i++){
                SousFacture sf=new SousFacture(request.getParameter("designation"+Integer.toString(i)), Integer.valueOf(request.getParameter("quantite"+Integer.toString(i))),
                        Double.valueOf(request.getParameter("prix"+Integer.toString(i))),Integer.valueOf(request.getParameter("remise"+Integer.toString(i))));
                f.AjouterFille(sf);
            }
            f.Create(null);
        } catch (Exception e) {
            ...
            RequestDispatcher dispat = request.getRequestDispatcher("AjoutFacture");
